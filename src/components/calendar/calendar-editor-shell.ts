...
// The header row drops from 95px to 76px: at 620px tall, twenty pixels of empty
// header is a fifteenth of the whole dialog. The aside narrows with the window
// so the description keeps roughly the same share of the width.
export const CALENDAR_EDITOR_FORM_CLASS =
  "flex h-full min-h-0 flex-col overflow-y-auto lg:grid lg:grid-cols-[minmax(0,1fr)_minmax(320px,356px)] lg:grid-rows-[76px_minmax(0,1fr)_54px] lg:overflow-hidden lg:[grid-template-areas:'header_aside''main_aside''mainFooter_asideFooter']";
