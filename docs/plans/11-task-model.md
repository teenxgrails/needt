...
> **CANCELLED 2026-09-06, owner.** The sale animation is not built and the flame
> is removed from the product everywhere — it had been applied to overdue tasks,
> which this section never authorised. Overdue now reads as a red rail plus the
> title at `EXPO -40`, easing to 0 when the task is touched. The clause below
