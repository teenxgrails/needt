...
- Notification settings now report when browser push delivery is unavailable,
  while reminder workers warn once per process with the missing VAPID variable
  names.
